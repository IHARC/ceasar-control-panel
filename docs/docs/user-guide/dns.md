...
- **default-nomail**: Standard DNS template. Suitable for most usecases when you don’t want to host mail on Ceasar.
...
This date is not used by Ceasar, but can be used as a reminder.
