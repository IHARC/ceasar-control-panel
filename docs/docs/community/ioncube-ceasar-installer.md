# Install Ioncube on Ceasar

By [Jaap Marcus](https://github.com/jaapmarcus/)  
[Source code](https://github.com/jaapmarcus/ioncube-ceasar-installer)
...
```bash
wget https://raw.githubusercontent.com/jaapmarcus/ioncube-ceasar-installer/main/install_ioncube.sh
