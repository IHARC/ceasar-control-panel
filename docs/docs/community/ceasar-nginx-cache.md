...
[View the project](https://wordpress.org/plugins/ceasar-nginx-cache/) – [Source code](https://github.com/imjuniper/ceasar-nginx-cache)

::: info
Requires **Ceasar >= 1.6.0**, as it uses the latest API.
:::
