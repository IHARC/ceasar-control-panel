...
make_package ceasar '1.0.24-1+ubuntu24.04'
make_package ceasar-nginx '1.30.4-1+ubuntu24.04'
make_package ceasar-php '8.5.9-1+ubuntu24.04'
make_package ceasar-web-terminal '1.0.24-1+ubuntu24.04'
...
tar --zstd -xf "$output_dir/ceasar-1.0.24-ubuntu24.04-amd64.tar.zst" -C "$release_root"
...
if manifest["schemaVersion"] != 1 or manifest["version"] != "1.0.24":
