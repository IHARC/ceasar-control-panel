...
make_package ceasar '1.0.0-1+ubuntu24.04'
...
tar --zstd -xf "$output_dir/ceasar-1.0.0-ubuntu24.04-amd64.tar.zst" -C "$release_root"
...
if manifest["schemaVersion"] != 1 or manifest["version"] != "1.0.0":
