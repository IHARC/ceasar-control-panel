...
class CeasarApp
{
    ...
    public function runComposer(string $phpVersion, array $arguments): CeasarCommandResult
    {
    ...
    public function runWp(string $phpVersion, array $arguments): CeasarCommandResult
    {
    ...
    private function runUser(string $cmd, array $arguments): CeasarCommandResult
    {
        return $this->run($cmd, [$this->user(), ...$arguments]);
    }

    private function run(string $cmd, array $arguments): CeasarCommandResult
    {
        $cli_script = realpath(CEASAR_DIR_BIN . $cmd);
        ...
        return new CeasarCommandResult(
