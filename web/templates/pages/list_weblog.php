...
<head>
	...
	<?php require $_SERVER["CEASAR"] . "/web/templates/includes/title.php"; ?>
	<?php require $_SERVER["CEASAR"] . "/web/templates/includes/css.php"; ?>
	<?php require $_SERVER["CEASAR"] . "/web/templates/includes/js.php"; ?>
</head>
				...
				<div class="container top-bar-inner">
						<div class="top-bar-left">
							<a href="/" class="top-bar-logo" title="<?= tohtml(branding_name()) ?>">
								<img src="<?= tohtml(branding_asset_url("header_logo")) ?>" alt="<?= tohtml(branding_name()) ?>" width="54" height="29">
							</a>
						</div>
