...
if (isset($_GET["cpu"])) {
	...
	exec(CEASAR_CMD . "v-list-sys-cpu-status", $output, $return_var);
...
if (isset($_GET["mem"])) {
	$TAB = "MEMORY";
	include $_SERVER["DOCUMENT_ROOT"] . "/templates/pages/list_server_info.php";
	exec(CEASAR_CMD . "v-list-sys-memory-status", $output, $return_var);
	foreach ($output as $file) {
		echo $file . "\n";
	}
	end_html();
...
if (isset($_GET["disk"])) {
	$TAB = "DISK";
	include $_SERVER["DOCUMENT_ROOT"] . "/templates/pages/list_server_info.php";
	exec(CEASAR_CMD . "v-list-sys-disk-status", $output, $return_var);
	foreach ($output as $file) {
		echo $file . "\n";
	}
	end_html();
...
if (isset($_GET["net"])) {
	$TAB = "NETWORK";
	include $_SERVER["DOCUMENT_ROOT"] . "/templates/pages/list_server_info.php";
	exec(CEASAR_CMD . "v-list-sys-network-status", $output, $return_var);
	foreach ($output as $file) {
		echo $file . "\n";
	}
	end_html();
...
if (isset($_GET["web"])) {
	$TAB = "WEB";
	include $_SERVER["DOCUMENT_ROOT"] . "/templates/pages/list_server_info.php";
	exec(CEASAR_CMD . "v-list-sys-web-status", $output, $return_var);
	foreach ($output as $file) {
...
if (isset($_GET["dns"])) {
	$TAB = "DNS";
	include $_SERVER["DOCUMENT_ROOT"] . "/templates/pages/list_server_info.php";
	exec(CEASAR_CMD . "v-list-sys-dns-status", $output, $return_var);
	foreach ($output as $file) {
		echo $file . "\n";
	}
	end_html();
...
if (isset($_GET["mail"])) {
	$TAB = "MAIL";
	include $_SERVER["DOCUMENT_ROOT"] . "/templates/pages/list_server_info.php";
	exec(CEASAR_CMD . "v-list-sys-mail-status", $output, $return_var);
	if ($return_var == 0) {
		foreach ($output as $file) {
			echo $file . "\n";
		}
...
if (isset($_GET["db"])) {
	$TAB = "DB";
	include $_SERVER["DOCUMENT_ROOT"] . "/templates/pages/list_server_info.php";
	exec(CEASAR_CMD . "v-list-sys-db-status", $output, $return_var);
	if ($return_var == 0) {
		foreach ($output as $file) {
			echo $file . "\n";
		}
...
// Data
exec(CEASAR_CMD . "v-list-sys-info json", $output, $return_var);
